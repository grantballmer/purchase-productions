            ...
            <div className="contact-container">
              ...
              <div className="contact-form">
                ...
                <form action="https://send.pageclip.co/QcMnzdPbCpCO81edAo82vuLWMleknLnm" className="pageclip-form" method="post">
                  ...
                  <input type="tel" name="phone" placeholder="Phone Number" onChange={this.handleChange}/>
                  <textarea name="message" placeholder="Enter Message Here" onChange={this.handleChange}/>
                  <input type="submit" className="btn btn-link" value="Submit Message" />
                </form>
              </div>
            </div>
          }  
