              ...
              <div className="info">
                ...
                <div className="info__desc">
                  <p>
                    ...
                    with a mission to aid local and regional artists in
                    spreading their music and art across the country. With over
                    10 years of experience in the music industry, Purchase has
                    put together a team based out of Michigan with services that
                    include management, tour management, booking, professional
                  ...
                  <p>
                    ...
                    Carolina Catfish, Chirp, Conrad Shock & the Noise, House
                    With a Yard, Earth Radio, Isaac Berkowitz, and The Hacky
                    Turtles.
                  </p>
                </div>
              </div>
              ...
              <div className="details">
                ...
                <div className="details__desc">
                  ...
                  <p>
                    ...
                    degree in photography, Purchase took his love for music and
                    art to a professional level, managing a local band, booking
                    shows with Shakespeare's Lower Level in Kalamazoo, MI, and
                    starting his own business; Nathan Purchase Photography.
                  </p>
                  ...
                  <p>
                    ...
                    hundreds of concerts for a variety of publications and
                    bands, he started Purchase Productions in order to push the
              ...
              <div className="details">
                ...
                <div className="details__desc">
                  ...
                  <p>
                    ...
                    Berkowitz has brought his knowledge and skills of booking
                    and touring to Purchase Productions. Booking hundreds of
                    shows for his own band, he is now ready to help upcoming
                    local bands book their own tours on a tour by tour basis. He
